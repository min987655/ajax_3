	...
	<div class="container">
		...
		<div class="d-inline-flex m-3">
			<table class="table table-hover mt-5">
				<thead>
					...
					<tr>
						<th style="width: 150px; text-align: center; cursor: pointer;">번호</th>
						<th style="width: 150px; text-align: center; cursor: pointer;">팀명</th>
					</tr>
				</thead>
				<tbody id="kboTeam__list">
					<c:forEach var="kboTeam" items="${kboTeams}">
						<tr id="kboTeam-${kboTeam.id}" onclick="playerList(${kboTeam.id});">
		...
		<div class="d-inline-flex m-3">
			<table class="table table-hover mt-3">
				<thead>
					<tr>
						<th colspan="2" style="border-top-style: none; border-bottom-style: none; font-size: 35px">TeamPlayers</th>
					</tr>
					<tr>
						<th style="width: 150px; text-align: center; cursor: pointer;">번호</th>
						<th style="width: 150px; text-align: center; cursor: pointer;">이름</th>
					</tr>
				</thead>
		...
		<div class="d-inline-flex m-3">
			<table class="table table-hover mt-3">
				<thead>
					...
					<tr>
						<th style="width: 130px; text-align: center; cursor: pointer;">번호</th>
						<th style="width: 130px; text-align: center; cursor: pointer;">이름</th>
						<th style="width: 130px; text-align: center; cursor: pointer;">포지션</th>
					</tr>
				</thead>
				<tbody id="player__list">
					<c:forEach var="players" items="${playersList}">
						<tr id="players-${players.id}">
							<td style="text-align: center; cursor: pointer;">${players.id}</td>
							<td style="text-align: center; cursor: pointer;">${players.playerName}</td>
							<td style="text-align: center; cursor: pointer;">${players.position}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
